...
class LocationExceptionView extends StatelessWidget {
  @override
            ...
            child: Center(
              child: Column(
                ...
                children: [
                  Container(
                    height: 350,
                    child: Image.asset(Assets.switchImage),
                  ),
                  Gap(20),
                  Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        Gap(5),
                        Text(
                          'We need your location for accurate mapping. Please accept location permissions.',
                          style: heading3Style.copyWith(fontSize: 16.sp),
                        ),
                      ],
                    ),
